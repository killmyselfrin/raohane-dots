...
Item {
    ...
    function sectionDescription(key: string): string {
        ...
        case "bar": return qsTr("Control the bar and dock while preserving the shell's spatial rhythm.")
    ...
    Component {
        ...
        Item {
            ...
            function goTo(search: string): void {
                ...
                if (index >= 0)
                    settingsFlick.contentY = Math.max(0, index * 72 - 20)
            }
            ...
            Flickable {
                ...
                anchors.fill: parent
                contentWidth: width
                contentHeight: sectionColumn.implicitHeight + 48
                clip: true
                ...
                Column {
                    id: sectionColumn
                    y: 18
                    width: Math.min(settingsFlick.width - 48, 760)
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            ...
                            height: modelData.type === "text" ? 78 : 66
                            ...
                            Rectangle {
                                ...
                                radius: 12
                                color: settingRow.rowHovered && settingRow.toggleRow
                                    ? RaohaneTheme.surfaceHover
                                    : "transparent"
                                opacity: settingRow.rowHovered ? 1 : 0
                            ...
                            RowLayout {
                                ...
                                RaohaneSurface {
                                    ...
                                    Layout.preferredWidth: Math.min(330, sectionRoot.width * 0.44)
    ...
    RowLayout {
        ...
        Item {
            ...
            Layout.preferredWidth: root.compactNav ? 72 : 214
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                height: root.compactNav ? 42 : (firstInGroup ? 58 : 40)
                                ...
                                RaohaneSurface {
                                    ...
                                    RowLayout {
                                        ...
                                        RaohaneIcon {
                                            ...
                                            iconSize: 16
                                            fill: navItem.active ? 1 : navItem.hovered ? 0.4 : 0
