...
QtObject {
    ...
    readonly property var pages: [
        ...
        { key: "scenes", name: qsTr("Scenes"), icon: "tune", group: qsTr("SHELL"), subtitle: qsTr("Context-aware modes and application rules"), source: "RaohaneSettingsScenes.qml" },
    ...
    readonly property var searchOnlyEntries: [
        ...
        { section: "general", key: "mediaOverlayGamingAutoHideSeconds", label: qsTr("Gaming auto-hide"), detail: qsTr("Media & OSD") },
