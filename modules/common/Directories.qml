...
Singleton {
    ...
    property string userAvatarPathRicersAndWeirdSystems: Quickshell.shellPath("assets/images/default_avatar.svg")
    property string userAvatarPathRicersAndWeirdSystems2: Quickshell.shellPath("assets/images/default_avatar.svg")
