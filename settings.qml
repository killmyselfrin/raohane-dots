        ...
        RowLayout { // Titlebar with integrated search
            ...
            Rectangle {
                ...
                RippleButton {
                    ...
                    implicitWidth: 35
                    implicitHeight: 35
                    onClicked: Quickshell.execDetached([Quickshell.shellPath("scripts/raohane"), "lock", "activate"])
                    contentItem: MaterialSymbol {
                        anchors.centerIn: parent
                        horizontalAlignment: Text.AlignHCenter
                        text: "lock"
        ...
        RowLayout { // Window content with navigation rail and content pane
            ...
            Item {
                ...
                Timer {
                    ...
                    interval: 500
                    onTriggered: {
                        Quickshell.execDetached([Quickshell.shellPath("scripts/raohane"), "settings"])
                        Qt.quit()
                    }
                }
            }
