...
| Desktop widgets/editor | Rebuild on the Raohane widget SDK and desktop canvas | Next adoption layer |
| First-launch guide | Build a short Raohane Japanese-minimal onboarding flow | Next adoption layer |
...
2. First-launch guide plus configurable bar/widget composition.
3. Weather, calendar, idle and notification settings.
4. Desktop widget editor and widget faces.
