// YouTube Music AdBlock userscript for Raohane WebEngine
...
(function() {
    ...
    const LOG_PREFIX = '[Raohane-AdBlock]';
    ...
    function muteAdAudio() {
        ...
        if (player.classList.contains('ad-showing')) {
            if (!video.muted) {
                video.muted = true;
                video.dataset.raohaneMuted = 'true';
            }
        } else if (video.dataset.raohaneMuted === 'true') {
            video.muted = false;
            delete video.dataset.raohaneMuted;
        }
    }
