...
for registration in \
  '^RaohaneSurface .*RaohaneSurface.qml  '^singleton RaohaneSurfaceRegistry .*RaohaneSurfaceRegistry.qml$' \
...
printf 'phase3-core-framework-audit: complete v13 config, owned paths/widgets/models/helpers/surface registries and a unified animated registry-routed Settings workspace are valid\n'
 '^RaohaneDivider .*RaohaneDivider.qml  '^singleton RaohaneSurfaceRegistry .*RaohaneSurfaceRegistry.qml$' \
  '^singleton RaohaneSettingsPageRegistry .*RaohaneSettingsPageRegistry.qml$' \
  '^singleton RaohaneSettingsSectionRegistry .*RaohaneSettingsSectionRegistry.qml$' \
  '^singleton RaohaneSettingsRouter .*RaohaneSettingsRouter.qml$' \
  '^RaohaneSettingsNavigation .*RaohaneSettingsNavigation.qml$' '^RaohaneSettingsPageHeader .*RaohaneSettingsPageHeader.qml$' \
...
printf 'phase3-core-framework-audit: complete v13 config, owned paths/widgets/models/helpers/surface registries and a unified animated registry-routed Settings workspace are valid\n'
 '^RaohaneIconButton .*RaohaneIconButton.qml  '^singleton RaohaneSurfaceRegistry .*RaohaneSurfaceRegistry.qml$' \
  '^singleton RaohaneSettingsPageRegistry .*RaohaneSettingsPageRegistry.qml$' \
  '^singleton RaohaneSettingsSectionRegistry .*RaohaneSettingsSectionRegistry.qml$' \
  '^singleton RaohaneSettingsRouter .*RaohaneSettingsRouter.qml$' \
  '^RaohaneSettingsNavigation .*RaohaneSettingsNavigation.qml$' '^RaohaneSettingsPageHeader .*RaohaneSettingsPageHeader.qml$' \
