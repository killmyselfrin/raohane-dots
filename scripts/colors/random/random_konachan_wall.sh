...
QUICKSHELL_CONFIG_NAME="raohane"
...
userAgent=$(jq -r '.networking.userAgent // empty' "$raohaneConfigPath" 2>/dev/null)
...
currentWallpaperPath=$(jq -r '.background.wallpaperPath' "$raohaneConfigPath")
