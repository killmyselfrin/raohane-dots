...
for registration in \
  '^singleton RaohaneFocusGrab .*RaohaneFocusGrab.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^singleton RaohaneState .*RaohaneState.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^singleton RaohaneSettingsPageRegistry .*RaohaneSettingsPageRegistry.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^singleton RaohaneSettingsSectionRegistry .*RaohaneSettingsSectionRegistry.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^singleton RaohaneSettingsRouter .*RaohaneSettingsRouter.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsNavigation .*RaohaneSettingsNavigation.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsPageHeader .*RaohaneSettingsPageHeader.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsSectionPage .*RaohaneSettingsSectionPage.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsControlRow .*RaohaneSettingsControlRow.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsPreferences .*RaohaneSettingsPreferences.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
...
printf 'core-framework-audit: native paths/config/state/focus, Sakura ambience, animated registry-routed Settings workspace, primary coordinator and boot boundaries are valid\n'
 \
  '^RaohaneSettingsLanguage .*RaohaneSettingsLanguage.qml[[ "$(tr -d '\r' < "$root_qmldir")" == 'module qs' ]] || fail 'root qs module exports legacy types'
if rg -n 'GlobalStates|RaohaneLegacyBridge' "$root_qmldir" "$raohane_qmldir"; then
  fail 'legacy root/bridge singleton is registered in active modules'
fi
