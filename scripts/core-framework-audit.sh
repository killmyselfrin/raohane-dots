...
printf 'core-framework-audit: native paths/config/state/focus/settings router/coordinator/navigation/header/registry/control-row, primary coordinator and boot boundaries are valid\n'
